...
/**
 * D3D11 av_frame descriptor for pool allocation.
 *
...
typedef struct AVD3D11FrameDescriptor {
    /**
     * The texture in which the av_frame is located. The reference count is
    ...
    /**
     * The index into the array texture element representing the av_frame, or 0
