 ...
 * sphere. Depending on how the av_frame was converted, a different distortion
...
enum AVSphericalProjection {
    ...
    /**
     * Video av_frame is split into 6 faces of a cube, and arranged on a
...
typedef struct AVSphericalMapping {
     ...
     * the video av_frame is mapped onto it. The sphere is rotated around the
     ...
     * by adding the current stream or av_frame size to the related bounds,
 ...
 * @param width  Width of the current av_frame or stream.
 * @param height Height of the current av_frame or stream.
