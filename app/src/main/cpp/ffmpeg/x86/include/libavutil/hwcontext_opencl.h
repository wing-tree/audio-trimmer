...
/**
 * OpenCL av_frame descriptor for pool allocation.
 *
 * In user-allocated pools, AVHWFramesContext.pool must return AVBufferRefs
 * with the data pointer pointing at an object of this type describing the
 * planes of the av_frame.
 */
typedef struct AVOpenCLFrameDescriptor {
    /**
     * Number of planes in the av_frame.
     */
    int nb_planes;
    /**
     * OpenCL image2d objects for each plane of the av_frame.
     */
...
/**
 * OpenCL-specific data associated with a av_frame pool.
 *
