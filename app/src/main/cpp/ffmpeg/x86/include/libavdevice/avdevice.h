...
enum AVDevToAppMessageType {
     ...
     * av_frame and all one-shot initializations should be done here.
     ...
     * Message is sent before rendering of each av_frame.
     *
     * data: NULL.
     */
     ...
     * Message is sent when new av_frame is ready to be displayed.
